...
<div class="headers">
      <div class="header">
        <div class="logo1"><a href="#"><img src="image/logo2.jpg" alt="" width="326" height="87" border="0"></a><a href="#"></a>
        </div>
        
        <div class="lef-top-icon-logo"><img src="css/contact1.png" width="254" height="76" alt=""></div>
      </div>
  </div>
</div>
...
<?php
	   $conn=@mysql_connect("localhost","root","");
		...
		mysql_select_db("project");
		  ...
		  $wtm=$_REQUEST['t23'];
		  $tnt=$_REQUEST['t24'];
		  		  		$qry="insert into senior_citizen(name,d_o_b,age,address,gender,religion,tel_no,mb_no,dist,p_station,email,y_o_retair,no_of_child,family,health,residing,rel_name,relation,r_address,r_tel_no,servent,driver,watchman,tenant)
		      values('$nm','$db',$ag,'$add','$gn','$re','$tn','$mb','$dist','$ps','$em','$yor','$noc','$fmly','$hlth','$rw','$rnm','$r','$radd','$rtm','$ser','$dri','$wtm','$tnt')";
			  mysql_query("$qry");
			  if(mysql_affected_rows()>0)
			  {
				  header("location:get-registration-senior.php");
			  }
			  else 
			  {
