...
<ul id="flexmenu2" class="flexdropdownmenu jqflexmenu" style="display: none; visibility: visible; z-index: 1000;">
        ...
        <li><a href="#">Downlodable Forms</a></li>
...
<ul id="flexmenu5" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1001; left: 788px; top: 152px; display: none;">
        <li><a href="#">what is section 144</a></li>
  ...
  <div class="wraper">
    <div class="main">
      <div class="left-side-page-index">
        ...
        <div></div><br>
        <table width="100%" boder="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          <tbody>
          <tr>
             <td>&nbsp;</td>
          </tr>
...
<div class="right-index-main">
        ...
        <div class="boxes-main we-are-near-m">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody><tr>
              <td><p class="mission_heading">Go's Mess Accommodation &amp; Tariff</p></td>
            </tr>
            <tr>
              <td align="center"><h3 style="margin-bottom:0px;">EXTRACT OF STANDING ORDER NO. 302</h3></td>
            </tr>
            <tr>
              <td align="center"><h3 style="margin-bottom:0px;">RANCHI POLICE GAZETTED OFFICERS TRANSIT RULES</h3></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td align="center"><h4>Availability and Tariff of the Ranchi Police Gazetted Officers located at Morabadi<br>
              known as "Ranchi Police Gazetted Officers Transit Mess".</h4></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td align="center"><h3>ACCOMMODATION</h3></td>
            </tr>
            <tr>
              <td align="center"><table border="0" cellspacing="0" cellpadding="0" class="td-space">
                <tbody><tr>
                  <td>1</td>
                  <td>Single Rooms</td>
                  <td>16</td>
            ...
            <tr>
              <td align="center">(All attached with Bathroom).</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            <tr><td><a href=""><input type="button" value=">>next<<"></a></td></tr>
      </tbody>
      </table>
      </div>
        </div>
