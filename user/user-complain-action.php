...
<ul id="flexmenu2" class="flexdropdownmenu jqflexmenu" style="display: none; visibility: visible; z-index: 1000;">
        <li><a target="_blank" href="#">Missing Children</a></li>
        <li><a target="_blank" href="#">Missing Persons</a></li>     
        <li><a target="_blank" href="#">Un-Identified Children Found</a></li>
        
        <li><a target="_blank" href="#">Un-Identified Persons Found</a></li>
        <li><a target="_blank" href="#">Un-Identified Dead Bodies</a></li>
        <li><a href="#">Senior Citizens Registration</a></li>
        <li><a href="#" target="_blank">Stolen Vehicles Search</a></li>
        <li><a href="#" target="_blank">Unclaimed Vehicles Search</a></li>
        <li><a target="_blank" href="#">Missing/Stolen Mobile Phones</a></li>
        <li><a href="#">SMS Services of Delhi Police</a></li>
        <li><a href="#">Guidelines / Information in c/w passport verification and registration of Pakistan National</a></li>
        <li><a href="#">Most Wanted</a></li>
        <li><a href="#">Downloadable Forms</a></li>
        <li><a href="#">Go's Mess Accommodation &amp; Tariff</a></li>
        </ul>
<ul id="flexmenu3" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1003; left: 534px; top: 152px; display: none;">
        <li><a target="_blank" href="user-status.php">get your status</a>
        </li>
 ...
 <li><a target="_blank" href="watch-criminal.php">see criminals</a>
        </li>
        </ul>
    </div>
</div> 
    ...
    <div class="main">
      <div class="left-side-page-index">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          ...
          <tr>
            <td><a href="" target="_blank"><img src="image/traffic-unit copy.png" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          ...
          <tr>
            <td><a href="#" target="_blank"><img src="image/licensing-unit.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          ...
          <tr>
            <td><a href="#"><img src="image/women-helpline-tab.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          ...
          <tr>
            <td><a href="#"><img src="image/security-of-ne-res.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr><td>&nbsp;</td></tr>
        </tbody></table>
      </div>
...
<div class="clr"></div>
<div style="min-height:314px;" class="text-cont">
     
  <!-- <img style="padding-left:10px; width:220px; height:176px; float:right;" src="images/cp.jpg"/> -->
     ...
     <?php
	   $conn=@mysql_connect("localhost","root","");
		...
		$qry="insert into complain(fir_id,name,address,phn_number,complain,date)
		values($fi,'$nm','$ad','$pn','$cm','$dt')";
			  mysql_query("$qry");
			  if(mysql_affected_rows()>0)
			  {
				  echo"<span style='color:green'><strong>your complain has been accepted<p>try to quick action...</p></strong></span>                      ";
			  }
	 ?>
