...
<div class="headers">
      <div class="header">
        <div class="logo1"><a href="#"><img src="image/logo1.png" alt="" width="325" height="73" border="0"></a><a href="#"></a>
        </div>
    ...
    <div class="main">
      <div class="left-side-page-index">
        <div class="img-main-in1">
          ...
          <div class="text-im1">Shri M.V. Rao (IPS)<br>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          ...
          <tr>
            <td><a href="licencing.php" target="_self"><img src="image/licensing-unit.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
             <td>&nbsp;</td>
          </tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td><em><img src="image/lost-report-img.jpg" alt="" width="407" height="110" border="0" usemap="#Map"></em></td>
          </tr>
          <tr>
            <td height="25">&nbsp;</td>
          </tr>
            ...
            <td>
            	<div class="news-flash-bott1">
            	  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            	    ...
            	    <tr>
            	      <td><marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" scrollamount="4" width="100%">
    
    <a href="#" target="_blank">Annual Review 2013</a>    
         &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="#" target="_blank">Women Help line Numbers</a>
         &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="#" target="_blank"> Night GO's Telephone Numbers</a>
         &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="#" target="_blank">REWARD FOR GIVING INFORMATION</a>
         &nbsp;&nbsp;&nbsp;&nbsp;
         Follow Ranchi Traffic Police on 
    <a href="#" target="_blank">facebook </a>/ 
    <a href="#" target="_blank">twitter</a></marquee></td>
          	      </tr>
          	      </tbody></table>
            	</div>
            </td>
        ...
        <td width="33%" align="right" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><a href="telephone_directory.php"><img src="image/department-contacts.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
             <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><a href="tender.php" target="_self"><img src="image/tenders.jpg" width="242" height="29" alt=""></a></td>
          </tr>
        </tbody></table></td>
        </tr>
    </tbody></table></td>
...
<div class="footer-main">
  <div class="footer">
    <table border="0" align="center" cellpadding="0" cellspacing="0">
      <tbody><tr>
        <td align="center" style="margin-top:10px;">Copyright© Amit Kumar, Doranda College Ranchi, 2020 All Right Reserved </td>
        <td align="right">&nbsp;</td>
